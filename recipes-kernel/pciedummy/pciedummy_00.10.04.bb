...
do_compile:prepend() {
	cp ${S}/Makefile.kernel ${S}/Makefile
	sed -e 's/@mtcadummy_MAJOR_VERSION@/"00"/' -e 's/@mtcadummy_MINOR_VERSION@/"10"/' -e 's/@CMAKE_PROJECT_VERSION@/${PV}/' ${S}/version.h.in >${S}/version.h
}
